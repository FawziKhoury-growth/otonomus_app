...
class PropertyModel {
    ...
    factory PropertyModel.fromJson(Map<String, dynamic> json) => PropertyModel(
        ...
        availableSpaces: List<AvailableSpace>.from(json["availableSpaces"].map((x) => AvailableSpace.fromJson(x))),
    );

    Map<String, dynamic> toJson() => {
        "propertyId": propertyId,
        "propertyName": propertyName,
        "availableSpaces": List<dynamic>.from(availableSpaces.map((x) => x.toJson())),
    };
}
